...
def main(
    ...
    print ("Uploading !!")
    from gallery.upload_csv, test_training_config, format_litgpt_df, sync_metadata, upload_df
    import pandas, datetime, os
    file_to_upload = os.path.join(os.environ(['EXPERIMENT_LOCAL_DIR']), ".csv")
    df: pd.DataFrame = pd.read_csv(file_to_upload)
